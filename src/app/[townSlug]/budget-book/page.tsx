  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-8 py-12">
          ...
          <table className="w-full text-sm mt-4">
            <thead>
              <tr className="border-b-2 border-gray-300">
                <th className="text-left py-2 font-semibold">Function Area</th>
                <th className="text-right py-2 font-semibold">FY{currentYear} Budget</th>
          ...
          <table className="w-full text-sm mt-4">
            <thead>
              <tr className="border-b-2 border-gray-300">
                ...
                <th className="text-right py-2 font-semibold">FY{revYears.currentYear} Budget</th>
                <th className="text-right py-2 font-semibold">% of Total</th>
              </tr>
            </thead>
            <tbody>
            ...
            <table className="w-full text-sm mt-4">
              <thead>
                <tr className="border-b-2 border-gray-300">
                  ...
                  <th className="text-left py-2 font-semibold">Funding Source</th>
                </tr>
              </thead>
              <tbody>
        ...
        {/* Footer */}
        <footer className="text-center text-xs text-gray-400 mt-16 pt-8 border-t border-gray-200">
